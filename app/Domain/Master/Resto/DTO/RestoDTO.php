...
class RestoDTO
{
    public function __construct(
        ...
        public readonly ?string $kode_resto,
        ...
        public readonly ?string $no_hp_supervisor,
        public readonly ?string $stokis,
    ...
    public static function fromRequest(array $data): self
    {
        return new self(
            ...
            kode_resto:    $data['kode_resto'] ?? null,
            ...
            no_hp_supervisor: $data['no_hp_supervisor'] ?? null,
            stokis:           $data['stokis'] ?? null,
            area:             $data['area'] ?? null,
            kota:          $data['kota'] ?? null,
